...
LEARNING_RATE = 0.10 # Speed of learning
NUM_EPOCHS = 1075 # Present the training data this number of times
OUTPUT_INTERVAL = 125 # Used for output during training

# Path to training or evaluation file
INPUT_FILE = "/Users/Andrew/Desktop/ANDREWTENSORFLOWFILES/train.csv"
# Path to the network model save file
MODEL_PATH = "/Users/Andrew/Desktop/ANDREWTENSORFLOWFILES/Generated/xor-model.ckpt"
